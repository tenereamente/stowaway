...
7. Once provisioning completes, you can go to the Deploy step.
...
1. Run `cap development deploy:setup deploy:migrations` 
2. Run `cap development deploy`. Repeat as needed to try new versions of the application.
