...
Continuous integration tests are run in [Travis CI](https://travis-ci.org/stowawayco/StowAway/)
"!https://travis-ci.org/stowawayco/StowAway.png!":https://travis-ci.org/stowawayco/StowAway
